...
MINIO_PORT=9000
MINIO_ACCESS_KEY=gza_minio_user
MINIO_SECRET_KEY=gza_minio_pass
MINIO_BUCKET=gzacinema
MINIO_PUBLIC_URL=https://gza-api.vulv.id.vn/storage
